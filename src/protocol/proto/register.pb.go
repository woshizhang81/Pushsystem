...
func (x *UserLocRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserLocRequest) ProtoMessage() {}

func (x *UserLocRequest) ProtoReflect() protoreflect.Message {
	mi := &file_register_proto_msgTypes[0]
...
// Deprecated: Use UserLocRequest.ProtoReflect.Descriptor instead.
func (*UserLocRequest) Descriptor() ([]byte, []int) {
	return file_register_proto_rawDescGZIP(), []int{0}
}

func (x *UserLocRequest) GetTs() int64 {
	if x != nil {
		return x.Ts
	}
	return 0
...
func (x *UserLocRequest) GetPushid() string {
	if x != nil {
		return x.Pushid
	}
	return ""
...
var file_register_proto_rawDesc = []byte{
	...
	0x12, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x22, 0x38, 0x0a, 0x0e, 0x55, 0x73, 0x65, 0x72,
	0x4c, 0x6f, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x74, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x75,
	0x73, 0x68, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x75, 0x73, 0x68,
...
var file_register_proto_goTypes = []interface{}{
	(*UserLocRequest)(nil), // 0: protos.UserLocRequest
}
